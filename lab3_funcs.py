...
def inversions(items):
    ...
    if len(items) != 3: 
        return -1
    elif items[0] < items[1] < items[2]: #0
        return 0
    elif items[0] < items[1] > items[2] and items[0] < items[2]:  #1
        return 1
    elif items[0] > items[1] < items[2] and items[0] < items[2]: #1
        return 1
    elif items[0] < items[1] > items[2] and items[0] > items[2]: #2
        return 2
    elif items[0] > items[1] > items[2]: #3
        return 3
    elif items[2] > items[1] < items[2] and items[0] > items[2]: #2
        return 2
